...
try {
 ...
 const keys=["version","title","author","sourceHost","layout","platform"];
 if(!data || Array.isArray(data) || Object.keys(data).some(k=>!keys.includes(k)) || data.version!==1 || typeof data.title!=="string" || !data.title || data.title.length>900) throw Error();
